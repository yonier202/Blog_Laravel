...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @auth {{--Si ya esta autenticado muestra nav del perfil--}}
                    <!-- Settings Dropdown -->
                        <div class="ms-3 relative">
                            <x-dropdown align="right" width="48">
                                ...
                                @can('admin') {{--gate, si admin es true se muestra el enlance--}}
                ...
                @else {{--Si no esta autenticado muestra el LOGIN Y REGISTER--}}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @guest  {{--no mostrar cuando ya se haya iniciado sesion--}}
